...
/*TASK 1 list Id,first_name,last_name,depatment_id,department_name & 
 list the employee details from 'IT' department*/
...
/* TASK 2 Extract the minimum and maximum salaries from each department*/

SELECT MAX(salary),MIN(salary),department_name FROM employees INNER JOIN departments USING
(department_id) GROUP BY department_name; 

----------------------------------------------------------------------------------------------------------------


/* TASK 3 Identify the top 10 cities with highest number of employees*/

SELECT MAX(employee_id),city FROM employees INNER JOIN departments 
ON departments.department_id=employees.department_id INNER JOIN locations 
ON locations.location_id=departments.location_id GROUP BY city limit 10;

-----------------------------------------------------------------------------------------------------------------

/* TASK 4 List the ID,first names,lastnames of employees whose last dat of working was 1999-21-31 */

SELECT employees.employee_id,Employees.first_name,employees.last_name,job_history.end_date 
FROM employees,departments INNER JOIN job_history 
ON departments.department_id=job_history.department_id WHERE end_date='1999-12-31';

------------------------------------------------------------------------------------------------------------------

/* TASK 5 List ID,first name,department names, total experience of employees with atleast 25 years
of experience */

SELECT employees.Employee_id,employees.first_name,departments.department_name,
YEAR(CURDATE())-YEAR(employees.hire_date)AS experience FROM employees JOIN departments
